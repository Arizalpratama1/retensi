<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <!-- Brand -->
        <a href="/home">
            <img src="{{ asset('argon') }}/img/brand/rsia.png" style="width: 180px; height: 40px;" alt="...">
        </a>
        <!-- User -->
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/rm*') ? 'active' : '' }}"
                        href="{{ url('/admin/rm') }}">
                        <i class="far fa-newspaper text-blue"></i>Library
                    </a>
                </li>
